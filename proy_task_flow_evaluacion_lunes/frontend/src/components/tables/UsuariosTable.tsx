import { Pencil, Trash2, Users, KeyRound } from "lucide-react";
...
export default function UsuariosTable({ usuarios, loading, onEditar, onEliminar, onCambiarPassword }: Props) {
            ...
            <tr key={u.id} className="border-t border-slate-50 hover:bg-slate-50/50 transition-colors">
              ...
              <td className="px-5 py-3">
                <div className="flex gap-2">
                  ...
                  <Button variant="ghost" onClick={() => onCambiarPassword(u)} icon={<KeyRound size={14} />}>
                    Contraseña
                  </Button>
